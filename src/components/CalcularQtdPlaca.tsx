...
export function CalcularQtdPlaca() {
  ...
  async function calcularQtdPlaca(event: FormEvent) {
  ...
  return (
    <form onSubmit={calcularQtdPlaca} className="w-full flex flex-col mt-6">
      <label htmlFor="title" className="font-semibold leading-tight">
        Calcular Quantidade de Placas [Informar kWh]
      </label>
